...
I am unsure if this applies to my session. Assuming it applies to my session,
then I can imagine that a learner want to learn the details of a language
first before doing something useful with it. The book I used follows
the idea that it is most useful to start with doing useful work.

I am unsure about the 'other tools to make the code work'.

Even though I understand the learner's preconception about what learning
...
It is true the two teachers never spoke (I was ill, so the other had
to hop in on short notice). I infer the other teacher has the idea
that learning how to program is about learning the details of the
language, which is dissonant with the book I used.

I agree the group still had a wide range of experience.
That is why we made the session optional.
...
I inferred earlier the other teacher has the idea
that learning how to program is about learning the details of the
language, which is dissonant with the book I used.
Here I infer that this learner has the preconception that
learning a programming language is about learning data types.
